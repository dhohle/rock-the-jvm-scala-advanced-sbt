...
object HigherKindedType extends App {
  ...
  trait AHigherKindedType[F[_]] // higher-kinded type
...
//  println(multiply(new MonadOption[Int](Some(20)), new MonadOption[String](Some("Scala"))))
  println(multiply(List(1,2,3), List("a", "b")))
  println(multiply(Some(20), Some("Scala")))
